...
def handle_request(client_socket, DIRECTORY, INDEX_FILE, ERROR_404, SERVER_DIR):
    try:
        ...
        if os.path.isfile(file_path):
            ...
            if os.path.isfile(os.path.join(ERROR_404)):
                with open(os.path.join(ERROR_404), 'rb') as file:
                    file_data = file.read()
